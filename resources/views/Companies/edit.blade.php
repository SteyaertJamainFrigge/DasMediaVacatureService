        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" value="{{$company->name}}" class="form-control" placeholder="Name">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <label for="city"><strong>City:</strong></label>
                    <select class="form-control" id="city" value="{{$company->city->id}}" name="city_id">
